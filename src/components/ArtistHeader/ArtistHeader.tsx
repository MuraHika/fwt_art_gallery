    ...
    // <div style={{ width: "100%" }}>
      <div className={`artist-container artist-container--${theme}`}>
        ...
        <div className={`artist-info artist-info--${theme}`}>
          <span className='artist_info-bio'>
            He studied in the Russian Empire and the 
            United States, but spent most of his active life in England. He is best known for his portraits of his contemporaries.
            Experienced the influence of realists in the person of his friend Gustave Courbet and the Pre-Raphaelites, as well as 
            Japanese art. In a number of creative methods it was close to impressionism.
          </span>
